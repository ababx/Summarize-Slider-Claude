...
function initializeExtension() {
  ...
  const models = [
    ...
    { id: "claude-opus-4.5", name: "Claude Opus 4.5", provider: "anthropic", apiId: "anthropic-claude-opus-4.5" },
    { id: "claude-sonnet-4.5", name: "Claude Sonnet 4.5", provider: "anthropic", apiId: "anthropic-claude-sonnet-4.5" },
    { id: "claude-haiku-4.5", name: "Claude Haiku 4.5", provider: "anthropic", apiId: "anthropic-claude-haiku-4.5" },
